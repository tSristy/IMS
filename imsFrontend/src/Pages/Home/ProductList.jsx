  ...
  return (
    <div style={{ boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)', padding: '20px', borderRadius: '10px', width: 'fit-content', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '20px',  display: 'flex', alignItems: 'center' }}>
        <input type="text" placeholder="Search by product name" value={searchTerm} onChange={(e) => handleSearch(e.target.value)} style={{ padding: '5px', borderRadius: '5px', marginRight: '5px',width: 'calc(100% - 100px)' }} />
